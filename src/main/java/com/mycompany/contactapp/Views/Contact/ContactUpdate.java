 ...
 * @author Parasit
 */
public class ContactUpdate extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ContactUpdate
     */
    public ContactUpdate(ContactController _contactController, ContactView _contactView) {
    ...
    public void setData(Contact _contact) {
        contact = _contact;
        JFNama.setText(contact.getNama());
        JFNoHP.setText(contact.getHp());
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContactUpdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
